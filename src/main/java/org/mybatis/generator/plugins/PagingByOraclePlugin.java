...
public class PagingByOraclePlugin extends PluginAdapter {
	...
	private void addSelectAllElement(Document document, IntrospectedTable introspectedTable) {
		...
		prefixElement.addAttribute(new Attribute("refid", "com.cattsoft.baseplatform.func.sm.persistence.CommonMapper.pageHeader"));
		...
		suffixElement.addAttribute(new Attribute("refid", "com.cattsoft.baseplatform.func.sm.persistence.CommonMapper.pageFoot"));
	...
	private void addSelectAllCountElement(Document document, IntrospectedTable introspectedTable) {
		...
		XmlElement prefixElement = new XmlElement("include");
		prefixElement.addAttribute(new Attribute("refid", "com.cattsoft.baseplatform.func.sm.persistence.CommonMapper.countHeader"));
		answer.addElement(prefixElement);
		...
		XmlElement suffixElement = new XmlElement("include");
		suffixElement.addAttribute(new Attribute("refid", "com.cattsoft.baseplatform.func.sm.persistence.CommonMapper.countFoot"));
		answer.addElement(suffixElement);
