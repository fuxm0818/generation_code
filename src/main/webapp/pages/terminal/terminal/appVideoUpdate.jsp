...
<html>
	<head>
		...
		<script type="text/javascript" language="JavaScript">
			dt$.ready(function(){
				dt$.obj('#confirmUpdateBtn').click(appVideoUpdate);
				dt$.obj("#cancleUpdateBtn").click(cancleOpt);
				dt$.obj('#resetUpdateBtn').click(function(){
					document.forms['parameters'].reset();
					//xxx.selectedByValue("appVideo.xxx");
				});
			});
			//修改
			function appVideoUpdate() {
				if (dt$.validate('#parameters')) {
					var url = "terminal/AppVideoAction!update.action";
	...
	<body>
		<div class="ui-widget-content func-panel">
			...
			<s:form id="parameters">
					<s:hidden id="appVideoId" name="appVideo.appVideoId"></s:hidden>
